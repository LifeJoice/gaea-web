...
public interface CommonCRUDService {
    void deleteById(String urSchemaId, String gridId, String recordId, String wfProcInstId, String deleteReason) throws ValidationFailedException, SysLogicalException, SystemConfigException, SysInitException;
