...
/**
 * 这个主要解决activiti 5.16后ProcessDiagramGenerator转移到image包后的乱码问题。主要是以前的处理乱码的方式没有继承过来。
 * 如果以后activiti解决了该乱码问题，就可以不用自己的ProcessDiagramGenerator。
 * Created by Iverson on 2015/6/1.
 */
public class GaeaProcessDiagramGenerator extends org.activiti.image.impl.DefaultProcessDiagramGenerator {
    ...
    protected static DefaultProcessDiagramCanvas initProcessDiagramCanvas(BpmnModel bpmnModel, String imageType,
        ...
        return new GaeaDefaultProcessDiagramCanvas((int) maxX + 10,(int) maxY + 10, (int) minX, (int) minY,
                 customClassLoader);
    }
}
