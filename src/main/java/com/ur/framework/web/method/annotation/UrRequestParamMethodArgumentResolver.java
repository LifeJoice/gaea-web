package com.ur.framework.web.method.annotation;
 ...
 */
@Component
public class UrRequestParamMethodArgumentResolver implements HandlerMethodArgumentResolver {

    @Override
    public boolean supportsParameter(MethodParameter parameter) {
        return parameter.getParameterAnnotation(UrModelAttribute.class) != null;
    }
